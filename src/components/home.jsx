...
class Home extends Component {
    ...
    async componentWillMount() {
        await axios.get("http://192.168.1.130:3001/orders").then(response => {
        ...
        await axios.get("http://192.168.1.130:3001/count").then(response => {
    ...
    async change1() {
        ...
        //            console.log(this.state.listData2);
        //           await axios.put("http://192.168.1.147:3001/orders/" + this.state.listData2[i].order_id, this.state.listData2[i]).then(response => {
