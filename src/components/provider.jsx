...
class Provider extends Component {
    ...
    console.log(this.state.selectdata)
        ...
        var response1 = await axios.get("http://192.168.1.130:3001/provider")   
   ...
   async check2(){
       console.log(this.state.selectdata);
       console.log(this.state.prodid1);
       await axios.put("http://192.168.1.130:3001/provider/"+this.state.selectdata.provider_id, this.state.selectdata).then(response => {
    ...
    async check() {
        ...
        console.log(this.state.provider);
        await axios.post("http://192.168.1.130:3001/provider", this.state.provider).then(response => {
            console.log(response);
        }).catch(error => console.log(error)
        )
    }
